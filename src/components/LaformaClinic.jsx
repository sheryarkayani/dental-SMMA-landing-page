export default function LaformaClinic() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-8">
              CUSTOMER <span className="text-[#D03837] underline">STORIES</span>
            </h2>
            ...
            <div>
              ...
              <p className="text-[#888888] whitespace-pre-line">
                Hair Transplant Surgeon, Plastic Surgeon
                MBBS, MRCS (UK), EMSB, FCPS (Plastic Surgery)
              </p>
            </div>
            <div>
              <img 
                src="/images/image24.jpg" 
                alt="Laforma Clinic Results" 
