export default function BariatricSuccess() {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
          <span className="whitespace-pre-line">
            See How We Helped
            Dr. Shahryar Niazi
            <span className="text-[#D03837] underline block">
              Book Over 2,000 Laparoscopic & Bariatric Surgeries!
            </span>
          </span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-[#888888] whitespace-pre-line">
                MBBS (KEMU), FCPS (General Surgery)
                Advanced Laparoscopic Surgeon and Surgical Oncologist
              </p>
            </div>
          </div>
          <div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-xl font-bold mb-6">Problem Faced</h2>
          ...
          <div>
            <h2 className="text-xl font-bold mb-6">Results Delivered</h2>
            <ul className="list-disc pl-6 space-y-4 text-gray-600">
              <li>A fully optimized Meta profile established on both platforms.</li>
              <li>Generated over 2000+ surgeries directly through targeted Meta Ads campaigns.</li>
              <li>Effectively reached thousands of potential patients while educating them on the benefits of bariatric procedures.</li>
              <li>Increased lead generation has significantly contributed to the growth of Dr. Niazi's practice and its reputation in the weight loss community.</li>
            </ul>
          </div>
        </div>
      </div>
